...
public:
	...
	virtual bool intersect(Ray &ray, vector<Intersection> &intersections, int depth = 1) =0;
	// members
	Vector3D center;
};
...
public: 
	...
	bool intersect(Ray &ray, vector<Intersection> &intersections, int depth);
	//members
	float radius;
};
...
class PolygonMesh:public Object {
	// polygon mesh is a
	PolygonMesh();
	bool intersect(Ray &ray, vector<Intersection> &intersections, int depth = 1);
};
